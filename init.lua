...
local options = ({...})[1] or { AutoDecode = true, Highlighting = true, SaveLogs = false, CLICommands = true, ShowResponse = true, BlockedURLs = {}, API = true };
...
local function printf(...) 
	if options.SaveLogs and append then
